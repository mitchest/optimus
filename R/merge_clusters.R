...
#' @param n.iter the number of merging iterations to perform
...
#'
#' @return a list containing the clustering solution data frame containing the delta AIC values for each variable in \code{data}. The object is of class \code{daic}.
#'
