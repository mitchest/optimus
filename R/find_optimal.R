...
#' @param cutree logical. Whether \code{\link[stats]{cutree}} should be used on the object supplied to the \code{clustering} argument
...
#' @examples
#'
#' ## Example using 1) an object that cutree works on, and 2) supplying a list of clustering solutions, from kmeans and from cutree(h=)
#'
#' @export
